...
```{r AUPRCVsDist, message=FALSE, warning=FALSE}
# plot performance as a function of distance to TSS
dist_auprc <- applyCellTypes(merged_bins_filt, .fun = plotPerfSubsets, pred_config = pred_config,
                             subset_col = "distToTSS (bins)", metric = "auprc",
                             subset_name = "Distance to TSS (kb)",
                             title = "AUPRC vs. distance to TSS", pos_col = pos_col, bs_iter = 1000)
